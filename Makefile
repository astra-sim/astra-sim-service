...
install-prerequisites:
	...
	wget https://github.com/Keysight/infragraph/releases/download/v0.6.1/infragraph-0.6.1-py3-none-any.whl
	pip install infragraph-0.6.1-py3-none-any.whl
	rm -f infragraph-0.6.1-py3-none-any.whl
