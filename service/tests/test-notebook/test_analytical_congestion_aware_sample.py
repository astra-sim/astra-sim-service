def test_analytical_congestion_aware_sample(port_number):
    ...
    try:
        ...
        astra = AstraSim(
            f"0.0.0.0:{port_number}", tag="analytical_congestion_aware_sample"
        )
        ...
        astra.configuration.common_config.workload = astra.generate_collective(
            collective=Collective.ALLTOALL, coll_size=8 * 1024 * 1024, npu_range=[0, 8]
        )
        ...
        astra.configuration.network_backend.analytical_congestion_aware.topology.network.add(
            "switch", 8, 100, 0.005
        ...
        print(
            ...
            astra.configuration.network_backend.analytical_congestion_aware.topology.choice,
        )
        ...
        print(
            astra.configuration.network_backend.analytical_congestion_aware.topology.network
        )
