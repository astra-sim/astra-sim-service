def test_analytical_congestion_aware_sample(port_number):
    ...
    try:
        ...
        astra = AstraSim(f"0.0.0.0:{port_number}", tag = "analytical_aware_trial")
        ...
        astra.configuration.network_backend.analytical_congestion_aware.topology.network.add("switch", 8, 100, 0.005)
