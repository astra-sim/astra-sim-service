def test_analytical_congestion_unaware_sample(port_number):
    ...
    try:
        ...
        astra = AstraSim(
            f"0.0.0.0:{port_number}", tag="analytical_congestion_unaware_sample"
        )
        ...
        astra.configuration.network_backend.analytical_congestion_unaware.topology.network.add(
            "fullyconnected", 8, 100, 0.005
        ...
        print(
            ...
            astra.configuration.network_backend.analytical_congestion_unaware.topology.choice,
        )
