def test_htsim_clos_fabric_2tier(port_number):
    ...
    try:
        ...
        astra.configuration.network_backend.choice = (
            astra.configuration.network_backend.HTSIM
        )
        astra.configuration.network_backend.htsim.topology.choice = (
            astra.configuration.network_backend.htsim.topology.INFRAGRAPH
        )
        ...
        print(
            "network topology choice set to:",
            astra.configuration.network_backend.htsim.topology.choice,
        )
        print(
            "protocol set to", astra.configuration.network_backend.htsim.htsim_protocol
        )
        astra.configuration.network_backend.htsim.htsim_protocol.tcp.nodes = str(
            total_npus
        )
