def test_htsim_sample(port_number):
    ...
    try:
        ...
        astra = AstraSim(f"0.0.0.0:{port_number}", tag="htsim_sample")
        ...
        astra.configuration.common_config.workload = astra.generate_collective(
            collective=Collective.ALLREDUCE, coll_size=1 * 1024 * 1024, npu_range=[0, 8]
        )
        ...
        # ##### Configure the network backend, htsim protocol and topology

        astra.configuration.network_backend.htsim.topology.network_topology_configuration.network.clear()
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.network.add(
            "ring", 8, 100, 0.005
        )  # add(type_of_topology, number_of_nodes, bandwidth_in_gbps, latency_in_ns)
        astra.configuration.network_backend.htsim.htsim_protocol.choice = (
            astra.configuration.network_backend.htsim.htsim_protocol.TCP
        )
        print("Network backend set to", astra.configuration.network_backend.choice)
        print(
            "network backend choice set to:",
            astra.configuration.network_backend.htsim.topology.choice,
        )
        print(
            "protocol set to",
            astra.configuration.network_backend.htsim.htsim_protocol.choice,
        ...
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.nodes = (
            8
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.podsize = (
            4
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tiers = (
            3
        )
        ...
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_0.radix_down = (
            2
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_0.radix_up = (
            2
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_0.downlink_latency_ns = (
            1000
        )
        ...
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_1.radix_down = (
            2
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_1.radix_up = (
            4
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_1.downlink_latency_ns = (
            1000
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_1.bundle = (
            1
        )
        ...
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_2.radix_down = (
            4
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_2.downlink_latency_ns = (
            1000
        )
        astra.configuration.network_backend.htsim.topology.network_topology_configuration.htsim_topology.fat_tree.tier_2.bundle = (
            2
        )

        astra.configuration.network_backend.htsim.htsim_protocol.tcp.nodes = "8"
        print(
            astra.configuration.network_backend.htsim.topology.network_topology_configuration
        )
