def test_ns3_single_tier_with_generic_server(port_number):
    ...
    try:
        ...
        astra = AstraSim(
            f"0.0.0.0:{port_number}", tag="ns3_single_tier_with_generic_server"
        )
        ...
        astra.configuration.infragraph.infrastructure.devices.append(server).append(
            switch
        )
        ...
        # annotation
        node = astra.configuration.infragraph.annotations.nodes.add("host")
        ...
        node = astra.configuration.infragraph.annotations.nodes.add("rack_switch")
        node.attributes.add(attribute="device_bandwidth_gbps", value="200")
        node.attributes.add(attribute="device_latency_ms", value="0.05")
